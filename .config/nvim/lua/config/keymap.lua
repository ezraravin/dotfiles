...
vim.keymap.set("n", "<leader>ts\\", "<cmd>silent !tmux split-window -h<cr>", { desc = "New Window Pane Horizontal" })
vim.keymap.set("n", "<leader>ts-", "<cmd>silent !tmux split-window -v<cr>", { desc = "New Window Pane Vertical" })
