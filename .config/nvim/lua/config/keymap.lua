...
vim.keymap.set("n", "<leader>mk", "<C-w>K", { desc = "Move Window Horizontally Top" })
vim.keymap.set("n", "<leader>mj", "<C-w>J", { desc = "Move Window Horizontally Bottom" })
vim.keymap.set("n", "<leader>mh", "<C-w>H", { desc = "Move Window Vertically Left" })
vim.keymap.set("n", "<leader>ml", "<C-w>L", { desc = "Move Window Vertically Right" })
