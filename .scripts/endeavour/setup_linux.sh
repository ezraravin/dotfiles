...
# Install Hyprland
sudo pacman -S --noconfirm hyprland hyprpaper hyprlock sway swaybg sway-lock zsh neovim tmux eza waybar obs-studio cava fastfetch yazi lazygit zoxide zsh-syntax-highlighting zsh-autosuggestions yarn fzf eza yazi lazygit thefuck wl-clipboard vlc blueman bat wofi btop nautilus
